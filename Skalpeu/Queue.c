...
#ifdef ALLOC_PRAGMA
#pragma alloc_text (PAGE, SkalpeuQueueInitialize)
#endif

NTSTATUS
SkalpeuQueueInitialize(
...
--*/
{
    ...
    queueConfig.EvtIoDeviceControl = SkalpeuEvtIoDeviceControl;
    queueConfig.EvtIoStop = SkalpeuEvtIoStop;
